...
public class Main {
	...
	public static void main(String[] args) 
	{
                ...
                Point a=new Point(186, 172);
                Point aa=new Point(207, 180);
                Point aaa=new Point(571, 907);
                Point av=new Point(905, 567);
                Point avv=new Point(313, 105);
                Point avvv=new Point(963, 821);
                Point az=new Point(609, 410);
                Point azz=new Point(411, 686);
                Point azzz=new Point(164, 1);
                /*/new Point(980, 340);
                new Point(515, 286);
                new Point(548, 23);
                new Point(568, 707);
            ...
            dt.addPoint(a);dt.addPoint(aa);dt.addPoint(aaa);dt.addPoint(av);dt.addPoint(avv);dt.addPoint(avvv);
            dt.addPoint(az);dt.addPoint(azz);//dt.addPoint(azzz);
            System.out.println(dt);
            Point[] array=dt.getPointsInRangeRegAxis(500, 899, true);
            for(Point p:array)
